...
return new class extends Migration
{
    ...
    private const NAMA_LAMA = 'Spidol';

    private const NAMA_ARSIP = 'Spidol (tanpa keterangan warna)';
    ...
    public function down(): void
    {
        ...
        foreach (self::WARNA as $warna) {
            ...
            $barang = DB::table('barang')->where('nama', $nama)->first();
